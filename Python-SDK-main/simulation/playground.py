...
class Robot:
    ...
    def draw(self, surface):
        ...
        text_poz = 2
        increase = 20
        text = font.render(f"Mozgas: WASD", True, TEXT_COLOR)
        surface.blit(text, (2,text_poz))
        text_poz += increase
        text = font.render(f"Palya rajzolas: bal eger, aztan huzzad | torles: ESC", True, TEXT_COLOR)
        surface.blit(text, (2, text_poz))
        text_poz += increase
        text = font.render(f"Celpont: jobb eger", True, TEXT_COLOR)
        surface.blit(text, (2, text_poz))
        text_poz += increase
        text = font.render(f"Robot inditasa: space", True, TEXT_COLOR)
        surface.blit(text, (2, text_poz))
        text_poz += increase
        text = font.render(f"Ujraspawnolas: T", True, TEXT_COLOR)
        surface.blit(text, (2, text_poz))
        text_poz += increase
        text = font.render(f"Leallitas: Q", True, TEXT_COLOR)
        surface.blit(text, (2, text_poz))
        text_poz += increase
